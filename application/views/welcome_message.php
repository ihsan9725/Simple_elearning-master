...
<head>
  ...
  <script type="text/javascript" src="http://localhost/Simple_elearning-master/jquery/dist/jquery.min.js">
    ...
    <script type="text/javascript" src="http://localhost/Simple_elearning-master/js/custom-scroller.js"></script>
  <script>
  $(document)
    .ready(function() {
  ...
  <div class="ui inverted vertical masthead center aligned segment" style="background-image:url(web-image/laptop.jpg);
    ...
    <div class="ui container">
      <div class="ui large secondary inverted pointing menu">
        ...
        <a class="active item" href="http://localhost/Simple_elearning-master/tampil" >Lihat Materi</a>
        <a class="item">Pengaturan</a>
        <a class="item">Tentang Kami</a>
        <div class="right item">
          <a href="login" class="ui inverted button" >Log in</a>
          <a href="login/regist" class="ui inverted button">Sign Up</a>
        </div>
      </div>
    </div>
    ...
    <div class="ui text container">
      <h1 class="ui inverted header">
        ...
        Tempatnya Belajar Online (E-learning)
      <br>
      <br>
        <h2><div class="element"></div></h2>
      <br>
      <a href="login" class="ui huge primary button" >Get Started <i class="right arrow icon"></i></a>
    </div>

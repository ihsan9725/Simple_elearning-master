...
<div class="ui middle aligned center aligned grid">
  <div class="column">
    ...
    <form class="ui large form" action="login/aksi_login" method="post">
    ...
    <div class="ui message">
        <h3><font color="Black">Belum daftar?</font> <?= anchor('http://localhost/Simple_elearning-master/regist','Daftar disini'); ?>
    </div>
  </div>
</div>
